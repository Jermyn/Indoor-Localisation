...
// });
// nobleRead$ = Rx.Observable.fromEvent(noble._bindings, 'read', function(peripheralUuid, serviceUuid, characteristicUuid, data, isNotification) {
//   return [peripheralUuid, serviceUuid, characteristicUuid, data, isNotification];
// });
...
noble$.subscribe(function(res) {
  if (res === 'poweredOn') {
    ...
    // return state.noble.scanning = true;
  } else {
    console.log('hci', res, 'stop scanning');
    noble.stopScanning();
    // return state.noble.scanning = false;
  }
});
...
//     // uuid.discoverCharacteristics([], function(err, characteristics) {
...
//     //       })
//     //       nobleRead$.filter(function([_peripheralUuid, _serviceUuid, _characteristicUuid, _data, _isNotification]) {
...
//     //         return console.log(`read ${uuid} successful`);
//     //       });
...
//       characteristics[uuid].on('read', function(data) {              
...
//   });
// });
// nobleRead$.subscribe(function([peripheralUuid, serviceUuid, characteristicUuid, data, isNotification]) {
//   let spO2 = 0; let bpm = 0;
//   [spO2, bpm] = readPoxData(data);
//   if (spO2 > 0 && bpm > 0) {
//     console.log('data from ' + poxid + '. spO2: ' + spO2 + ', bpm: ' + bpm + ', anchorid: ' + env.anchor);
