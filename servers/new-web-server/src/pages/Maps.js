...
import LoadMap from '../components/mapsFunction/maps'
...
class Maps extends Component {
    ...
    render() {
        const { currentMap, maps, staticDevices, featureCollection } = this.props;
        return (
            <div>
                <MapsPanel
...
export default connect(mapStateToProps, Actions)(withStyles(styles)(Maps))
