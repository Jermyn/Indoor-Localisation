...
class AnchorsTable extends React.Component {
  state = {
    order: 'asc',
    orderBy: 'anchor',
    selected: [],
  ...
  render() {
    const { classes, anchors, rooms } = this.props;
      ...
      <Paper className={classes.root}>
        ...
        <div className={classes.tableWrapper}>
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            />
            <TableBody>
              {anchors ? stableSort(anchors, getSorting(order, orderBy))
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" scope="row" padding="10px">
                        <RoomSelection rooms={rooms} onChange={this.props.onChange} anchor={n}/>
                      </TableCell>
...
const ConnectedAnchorsTable = connect(mapStateToProps, mapDispatchToProps)(AnchorsTable);
