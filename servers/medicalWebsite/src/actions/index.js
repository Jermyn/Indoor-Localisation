...
export const assignRoom = room => ({ type: ASSIGN_ROOM,
                                      payload: room});
...
export const updateFeatures = features => ({ type: UPDATE_FEATURES,
                                              payload: features});
...
export const fetchStaticDevices = staticDevices => ({ type: FETCH_DEVICES,
