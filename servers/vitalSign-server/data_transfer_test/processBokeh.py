...
dataEcgList = []
dataHrList = []
dataEcgList.append("ecg1Sample1,ecg1Sample2,ecg2Sample1,ecg2Sample2,ResRate1Sample1,ResRate1Sample2,ResRate2Sample1,ResRate2Sample2,timeStamp,sysTime,sequenceNumber")
...
tab1 = Panel(child=fig, title="Acceleration")
...
l1 = layout([[fig1, fig3]], sizing_mode='fixed')
tab2 = Panel(child=figH, title="Heart Rate")
tab3 = Panel(child=l1, title="ECG")

def dynamicGraphs(deviceId):
    global deviceQueue, cache
